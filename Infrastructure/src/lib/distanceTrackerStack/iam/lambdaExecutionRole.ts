...
export const lambdaExecutionRole = (scope: DistanceTrackerStack, deviceDynamoDbTableName: string, deviceDynamoDbStreamArn: string, deviceDistanceTrackerFunctionName:string): Role => 
